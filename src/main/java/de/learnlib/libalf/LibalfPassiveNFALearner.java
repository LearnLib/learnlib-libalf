...
import de.learnlib.passive.api.PassiveNFALearner;

class LibalfPassiveNFALearner<I> extends LibalfPassiveLearner<NFA<?,I>, I, Boolean>
		implements PassiveNFALearner<I> {
	
	protected LibalfPassiveNFALearner(AlgorithmID algId, Alphabet<I> alphabet,
			int ...otherOpts) {
